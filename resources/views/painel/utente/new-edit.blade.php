...
{{ Form::model( $utente, ['route' => ['utente.update',$codigo], 'class' => 'form', 'method' => 'put' ] ) }}
@else
            ...
            <div class="panel-body">
                ...
                <div class="col-md-6">
                    <div class="form-group {{$errors->has('codigo_postal') ? 'has-error' : ''}} ">
                        ...
                        {{  Form::text('codigo_postal', null, array('placeholder'=>'Ex. 42','class'=> 'form-control')) }}
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        {{  Form::label('entidade_financeira_id', 'Entidade Financeira (EF)') }}
                ...
                <div class="col-md-6">
                    <div class="form-group {{$errors->has('numero_EFR') ? 'has-error' : ''}} ">
                        {{  Form::label('numero_EFR', 'Nº na EF') }}
                        {{  Form::text('numero_EFR', null, array('placeholder'=>'Ex. 42','class'=> 'form-control')) }}
                        @if( $errors->has('numero_EFR') )
                        <span class="help-block" style="margin-top: -60px;margin-left:100px;font-size: 16px;margin-bottom:50px">
                            {{ $errors->first('numero_EFR') }}
                        </span>
                        @endif
                    </div>
                </div>
                ...
                <div class="col-xs-8" style="margin-left: 400px;margin-top:-140px;">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('password') ? 'has-error' : ''}}">
                            ...
                            <span class="help-block" style="margin-top: -60px;margin-left:75px;margin-bottom:40px;font-size: 15px">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('senha_permissao') ? 'has-error' : ''}}">
                            <label for="senha_permissao">Senha Permissao</label>
                            {{  Form::text('senha_permissao',null,['class' => 'form-control','placeholder'=>'senha de permissão']) }}
                             @if( $errors->has('senha_permissao') )
                            <span class="help-block" style="margin-top: 0px;margin-left:0px;margin-bottom:fixed;font-size: 15px">
                                {{ $errors->first('senha_permissao') }}
                            </span>
                            @endif
                        </div>
                    </div>
