...
{{ Form::model( $administrador, ['route' => ['administrador.update',$codigo], 'class' => 'form', 'method' => 'put' ] ) }}
@else
            ...
            <div class="panel-body">
                ...
                <div class="col-md-6">
                    <div class="form-group {{$errors->has('codigo_postal') ? 'has-error' : ''}}">
                        ...
                        <span class="help-block" style="margin-top: -60px;margin-left:100px;margin-bottom:0px;font-size: 16px">
                ...
                <div class="col-md-6">
                    <div class="form-group {{$errors->has('data') ? 'has-error' : ''}}">
                        ...
                        @if( $errors->has('data') )
                        <span class="help-block" style="margin-top: -60px;margin-left:125px;margin-bottom:50px;font-size: 16px">
                            {{ $errors->first('data') }}
                        </span>
                        @endif
                    </div>
